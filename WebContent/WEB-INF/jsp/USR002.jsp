...
<body>
	...
	<div class="container">
		...
		<div class="main_contents">
			<div id="sub_content">
				<form:form action="/SpringMvcStudentRegistration/updateUser" method="post" modelAttribute="data">
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<form:select class="form-select" aria-label="Education" id="userRole" path="userRole">
  								<c:choose>
									<c:when test="${data.userRole eq \"Admin\"}">
					...
					<div class="row mb-4">
						...
						<div class="col-md-6">
							...
							<button type="button" class="btn btn-secondary col-md-2 "
								onclick="location.href = '/SpringMvcStudentRegistration/userManagement'">Back</button>
						</div>
						</div>
				</form:form>
